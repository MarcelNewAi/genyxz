...
export default function WhySection() {
  ...
  return (
    <section id="zakaj" className="main-section main-section-soft">
      <div className="site-container section-narrow">
        ...
        <div className="why-grid" data-reveal data-reveal-style="up" data-reveal-delay="140">
          {blocks.map((block, index) => (
            <article key={block} className="main-card why-card" data-reveal data-reveal-style={index % 2 === 0 ? 'left' : 'right'} data-reveal-delay={`${200 + index * 90}`}>
